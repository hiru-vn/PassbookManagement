...
namespace DTO
{
    public class TypePassbook
    {
        ...
        string _kind;
        int _withdrawterm;
        long min_collectmoney;
        long min_passbookblance;
        ...
        public long Min_collectmoney { get => min_collectmoney; set => min_collectmoney = value; }
        public long Min_passbookblance { get => min_passbookblance; set => min_passbookblance = value; }
        ...
        public TypePassbook(DataRow row)
        {
            ...
            this.Min_collectmoney= long.Parse(row["min_collectmoney"].ToString());
            this.Min_passbookblance= long.Parse(row["min_passbookbalance"].ToString());
